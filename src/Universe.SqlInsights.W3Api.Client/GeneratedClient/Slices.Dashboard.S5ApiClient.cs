...
namespace Slices.Dashboard
{
    ...
    public partial class S5ApiClient 
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public S5ApiClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        ...
        public virtual async System.Threading.Tasks.Task<AboutResponse> IndexAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/v1/SqlInsights/About/Index"
                    urlBuilder_.Append("api/v1/SqlInsights/About/Index");
        ...
        public virtual async System.Threading.Tasks.Task IsOKAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/FakeHealthCheck/IsOK"
                    urlBuilder_.Append("api/v1/FakeHealthCheck/IsOK");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SqlInsightsSession>> SessionsAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Sessions/Sessions"
                    urlBuilder_.Append("api/v1/SqlInsights/Sessions/Sessions");
        ...
        public virtual async System.Threading.Tasks.Task<long> CreateSessionAsync(CreateSessionParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Sessions/CreateSession"
                    urlBuilder_.Append("api/v1/SqlInsights/Sessions/CreateSession");
        ...
        public virtual async System.Threading.Tasks.Task DeleteSessionAsync(IdSessionParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Sessions/DeleteSession"
                    urlBuilder_.Append("api/v1/SqlInsights/Sessions/DeleteSession");
        ...
        public virtual async System.Threading.Tasks.Task FinishSessionAsync(IdSessionParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Sessions/FinishSession"
                    urlBuilder_.Append("api/v1/SqlInsights/Sessions/FinishSession");
        ...
        public virtual async System.Threading.Tasks.Task ResumeSessionAsync(ResumeSessionParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Sessions/ResumeSession"
                    urlBuilder_.Append("api/v1/SqlInsights/Sessions/ResumeSession");
        ...
        public virtual async System.Threading.Tasks.Task RenameSessionAsync(RenameSessionParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Sessions/RenameSession"
                    urlBuilder_.Append("api/v1/SqlInsights/Sessions/RenameSession");
        ...
        public virtual async System.Threading.Tasks.Task<string> ActionsTimestampAsync(ActionsParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/ActionsTimestamp"
                    urlBuilder_.Append("api/v1/SqlInsights/ActionsTimestamp");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionDetailsWithCounters>> ActionsByKeyAsync(ActionsParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/ActionsByKey"
                    urlBuilder_.Append("api/v1/SqlInsights/ActionsByKey");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionSummaryCounters>> SummaryAsync(ActionsSummaryParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/Summary"
                    urlBuilder_.Append("api/v1/SqlInsights/Summary");
        ...
        public virtual async System.Threading.Tasks.Task<string> SummaryTimeStampAsync(ActionsSummaryParameters body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/SummaryTimeStamp"
                    urlBuilder_.Append("api/v1/SqlInsights/SummaryTimeStamp");
        ...
        public virtual async System.Threading.Tasks.Task<FiltersResult> PopulateFiltersAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/SqlInsights/PopulateFilters"
                    urlBuilder_.Append("api/v1/SqlInsights/PopulateFilters");
    ...
    public partial class AboutResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("dbCatalog", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("idSession", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("maxDurationMinutes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? MaxDurationMinutes { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CreateSessionParameters
    {
        [Newtonsoft.Json.JsonProperty("caption", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Caption { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class IdSessionParameters
    {
        [Newtonsoft.Json.JsonProperty("idSession", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long IdSession { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ResumeSessionParameters
    {
        [Newtonsoft.Json.JsonProperty("idSession", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long IdSession { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class RenameSessionParameters
    {
        [Newtonsoft.Json.JsonProperty("idSession", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long IdSession { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ActionsParameters
    {
        [Newtonsoft.Json.JsonProperty("idSession", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long IdSession { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("appsFilter", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> AppsFilter { get; set; }

        [Newtonsoft.Json.JsonProperty("hostsFilter", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> HostsFilter { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("topN", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int TopN { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SqlInsightsActionKeyPath
    {
        [Newtonsoft.Json.JsonProperty("path", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> Path { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class BriefSqlError
    {
        [Newtonsoft.Json.JsonProperty("sqlErrorCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SqlCounters
    {
        ...
        [Newtonsoft.Json.JsonProperty("reads", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long Reads { get; set; }

        [Newtonsoft.Json.JsonProperty("writes", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long Writes { get; set; }

        [Newtonsoft.Json.JsonProperty("rowCounts", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("sqlErrorCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? SqlErrorCode { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("sqlErrorText", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SqlErrorText { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ActionDetailsWithCounters
    {
        ...
        [Newtonsoft.Json.JsonProperty("hostId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("isOK", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool IsOK { get; set; }

        [Newtonsoft.Json.JsonProperty("exceptionAsString", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ExceptionAsString { get; set; }

        [Newtonsoft.Json.JsonProperty("briefException", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string BriefException { get; set; }

        [Newtonsoft.Json.JsonProperty("briefSqlError", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public BriefSqlError BriefSqlError { get; set; }

        [Newtonsoft.Json.JsonProperty("appDuration", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double AppDuration { get; set; }

        [Newtonsoft.Json.JsonProperty("appKernelUsage", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double AppKernelUsage { get; set; }

        [Newtonsoft.Json.JsonProperty("appUserUsage", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double AppUserUsage { get; set; }

        [Newtonsoft.Json.JsonProperty("sqlStatements", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<SqlStatement> SqlStatements { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ActionsSummaryParameters
    {
        [Newtonsoft.Json.JsonProperty("idSession", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long IdSession { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ActionSummaryCounters
    {
        [Newtonsoft.Json.JsonProperty("key", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public SqlInsightsActionKeyPath Key { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("requestErrors", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long RequestErrors { get; set; }

        [Newtonsoft.Json.JsonProperty("responseLength", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("sqlCounters", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public SqlCounters SqlCounters { get; set; }

        [Newtonsoft.Json.JsonProperty("sqlErrors", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class HostIdFilter
    {
        [Newtonsoft.Json.JsonProperty("hostId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string HostId { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("applicationList", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AppFilter> ApplicationList { get; set; }

        [Newtonsoft.Json.JsonProperty("hostIdList", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<HostIdFilter> HostIdList { get; set; }
    ...
    public partial class ApiException : System.Exception
    {
        ...
        public ApiException(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Exception innerException)
            : base(message + "\n\nStatus: " + statusCode + "\nResponse: \n" + ((response == null) ? "(null)" : response.Substring(0, response.Length >= 512000 ? 512000 : response.Length)), innerException)
        {
