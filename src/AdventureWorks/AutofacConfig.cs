        ...
        builder
            ...
            */
            ...
            builder
                .Register(c =>
                {
                    var sqlServerSqlInsightsStorage = new SqlServerSqlInsightsStorage(SqlClientFactory.Instance, SqlInsightsConfiguration.Instance.HistoryConnectionString) { Logger = ConsoleCrossPlatformLogger.Instance};
